    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(user !=null && !user.equals("")) {
            ...
            if(nick_name.contains("동")&&nick_name.contains("호")){
                ...
                //파이어베이스 참조 주소 설정
                db_Ref = database.getReference("residence/" + user_residence + "/house/" + user_dong + "동/" + user_num + "호/" + "소리");
                vibration_Ref = database.getReference("residence/" + user_residence + "/house/" + user_dong + "동/" + user_num + "호/" + "진동");
