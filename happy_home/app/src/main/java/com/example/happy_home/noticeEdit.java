...
public class noticeEdit extends AppCompatActivity {
    ...
    String ME, MY_Phone;
    String PostKey, Writer, Title, Text, Time, Phone;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        title = (EditText) findViewById(R.id.notice_title_E);
        text = (EditText) findViewById(R.id.notice_content_E);

        title.setText(Title);
        text.setText(Text);

        edit = (Button) findViewById(R.id.edit_notice);
        edit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(Title.equals("")){
                    ...
                    Notice noticeBoard=new Notice(Time, Title, ME, Text,MY_Phone);
                    Map<String,Object> userValue=noticeBoard.toMap();

                    Database.child("residence/" + user_residence + "/Notice/"+ PostKey).setValue(userValue);
