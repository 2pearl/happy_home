...
public class initialization extends AppCompatActivity {
    ...
    public String initialization(){
        ...
        if(dong.length()==0&&num.length()==0){
            ...
            DatabaseReference code_Ref = database.getReference("residence/"+user_residence+"/house/"+dong+"동/"+num+"호");
            ...
            DatabaseReference delList_Ref = FirebaseDatabase.getInstance()
                    .getReference("/residence/"+user_residence+"/house/"+dong+"동/"+num+"호/member");
            ...
            Task<Void> Database = FirebaseDatabase.getInstance()
                    .getReference("/residence/"+user_residence+"/house/"+dong+"동/"+num+"호/member").removeValue();
