...
public class Chatting extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(authority==0){
            Intent intent= new Intent(getApplicationContext(), chatListAdmin.class);
            //어디로갈지 넣어야함!!!!!!!!
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!lastchat_Ref.child("name").get().equals(nick_name)){
        ...
        send_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                SimpleDateFormat long_date_time = new SimpleDateFormat("yyyy-MM-dd kk:mm:ss");
